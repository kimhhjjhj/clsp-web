...
// + 골조 보조재 (갱폼·서포트·데크 등) 포함 — 2026-04 확장
...
// 가설 장비 trade (비계·호이스트·타워크레인 등)
const SCAFFOLD_EQUIPMENT = ['비계', '시스템비계', '호이스트', '타워크레인']

// 공동주택 마감 trade (대규모 확장 — 2026-04)
// 상봉동 일보 기반: EHP·창호·가구·엘리베이터·조경·도배 등 27종
