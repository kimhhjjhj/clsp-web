          ...
          <div className="flex h-full relative" style={{ background: '#d9dfe8' }}>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <header className="h-16 bg-white border-b border-slate-200 flex items-center px-3 sm:px-6 gap-3 sm:gap-5 flex-shrink-0">
                ...
                <Image src="/tongyang-logo.png" alt="TONGYANG" height={32} width={150} className="object-contain h-7 sm:h-8 w-auto flex-shrink-0" />
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button className="flex items-center gap-2 h-9 pl-1 pr-3 rounded-full hover:bg-slate-100 transition-colors">
